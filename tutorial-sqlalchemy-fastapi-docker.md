...
DATABASE_URL=postgresql+psycopg2://postgres:postgres@db:5432/fabrica
```
...
Reemplazá las primeras líneas del archivo generado:
...
# Agrega src/ al path para que Alembic encuentre los módulos
...
# El resto del archivo env.py generado por Alembic queda igual
```
...
Con este stack tenés una aplicación Python moderna, sin dependencias de Django:
